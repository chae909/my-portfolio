...
const Projects = () => {
    const projectData = [
        ...
        },
        {
            ...
            title: "Vision Transformer를 활용한 딥페이크 탐지",
            description: "국립과학수사연구원 주관 경진대회에서 Vision Transformer(ViT)를 도입하여 딥페이크 탐지 모델을 개발했습니다. Self-Attention 메커니즘과 주파수(FFT) 분석을 결합해 Macro F1-Score 98.83%를 달성했습니다.",
    ...
    return (
        <section id="projects" className="py-24 md:py-32">
            <div className="container mx-auto px-4">
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-12 border-b border-[#c3c6d5] pb-6">
                    <h2 className="font-headline text-5xl font-bold italic text-[#1b1c1d]">Selected Projects</h2>
                    <span className="text-xs uppercase tracking-[0.2em] text-[#434653]">Archived Works 2023–2025</span>
                </div>
